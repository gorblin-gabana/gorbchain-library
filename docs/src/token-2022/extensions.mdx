...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-close
Creating token C47NXhUTVEisCfX7s16KrxYyimnui7HpUXZecE2TmLdB under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
```
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --transfer-fee 50 5000
Creating token Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-freeze --default-account-state frozen
Creating token 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
SPL Token Account
  ...
  Program: G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
  Balance: 0
  Decimals: 9
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token
Creating token CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-non-transferable
Creating token 7De7wwkvNLPXpShbPDeRCLukb3CRzCNcC3iUuHtD6k4f under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token
Creating token EbPBt3XkCb9trcV4c8fidhrvoeURbDbW87Acustzyi8N under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --interest-rate 10
Creating token 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-permanent-delegate
Creating token 7LUgoQCqhk3VMPhpAnmS1zdCFW4C6cupxgbqWrTwydGx under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --transfer-hook 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj
Creating token HFg1FFaj4PqFHmkYrqbZsarNJEZT436aXAXgQFMJihwc under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --metadata-address 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj
Creating token HFg1FFaj4PqFHmkYrqbZsarNJEZT436aXAXgQFMJihwc under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-metadata
Creating token 5K8RVdjpY3CHujyKjQ7RkyiCJqTG8Kba9krNfpZnmvpS under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --group-address 7ZJVSav7y76M41eFeyA3xz39UDigQspVNwyJ469TgR1S
Creating token EUMhJgfvjZa7Lb7fSqfD6WCUwELzzRVKunKSnSi4xK42 under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-group
Creating token 812A34SxxYx9KqFwUNAuW7Wpwtmuj2pc5u1TGQcvPnj3 under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --member-address CXWuFdWifFQSvMMZ3UxZZVKtjYi2bZt89f5v3yV8zdVE
Creating token 5anZzJbbj6rBkrXW7zzw7MH28xXufj7AB5oKX1Cv4fdh under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
...
```console
$ spl-token --program-id G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6 create-token --enable-member
Creating token 9uyqmf9Ued4yQKi4hXT5wMzPF5Nv1S6skAjkjxcCaAyV under program G22oYgZ6LnVcy7v8eSNi2xpNk1NcZiPD8CVKSTut7oZ6
